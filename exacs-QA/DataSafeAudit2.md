...
### Part 1: Explore the All Activity report to view and analyze audit data
...
### Part 2: Explore the All Alerts report
...
### Part 4: Create a failed logins report in PDF format
...
### Part 5: Create a report to see which client programs are using the HCM1 database account and understand the activities being performed
...
### Part 6: Explore which users entitlements were changed
...
### Part 7: Explore the Data Access report
...
### Part 8: Explore the Data Modification report
...
### Part 9: Explore the Database Schema Changes report

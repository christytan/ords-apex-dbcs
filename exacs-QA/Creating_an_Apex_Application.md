...
- The second Python Application will upload tweets in the form of JSON objects using the REST Service we created in the earlier exercise. Please refer **Lab 14-2** for more information. 
...
- Please ensure you completed the previous parts of this lab before you start this lab. Refer [Lab 14-1](?lab=lab-14-1-install-ords-apex) and [Lab 14-2](?lab=lab-14-2-create-restservice-on-database) for more info.

...
- A pre-provisioned ExaCS database instance. Refer to Lab 3.
- A pre-provisioned Oracle Analytics Cloud instance. Refer [Here](https://docs.oracle.com/en/cloud/paas/analytics-cloud/acoci/create-services.html#GUID-D2F03D22-95FB-45C8-AB94-928AE4E167AB) to create Oracle Analytics Cloud.
...
9. Fill out the appropriate fields
    ![](./images/oac/enterinformation.png " ")

10. Once you enter your username and password, you can click Save to save the connection.

    ![](./images/oac/enteruserpass.png " ")

11. Click on Serach bar and select Connection
    
    ![](./images/oac/connection.png " ")

12. You can now see your ExaCS db connected to Oracle Analytics Cloud.

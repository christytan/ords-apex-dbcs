...
* [Getting started with GitHub](?lab=lab-12-1-git-for-beginner)
    - GitHub flow is a lightweight, branch-based workflow that supports teams and projects where deployments are made regularly.
* [Getting started with Terraform](?lab=lab-12-2-terraform-for-beginner)
...
* [Manage Database with Terraform](?lab=lab-12-3-terraform-for-database)
